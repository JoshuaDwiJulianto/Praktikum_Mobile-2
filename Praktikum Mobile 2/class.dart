...
void main() {
  ...
  mobil.tambahMuatan(hewan1); // Menambahkan hewan 1 ke dalam muatan
  mobil.tambahMuatan(hewan2); // Menambahkan hewan 2 ke dalam muatan
  mobil.tambahMuatan(hewan3); // Menambahkan hewan 3 ke dalam muatan

  print('Total muatan dalam mobil adalah: ${mobil.totalMuatan()} kg');
}
